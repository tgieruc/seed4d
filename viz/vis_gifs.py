...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--vehicles", nargs="+", help="Name vehicles to include. Must be int or ego_vehicles", default=["ego_vehicle"]
    )
    parser.add_argument(
        "--sensors",
        nargs="+",
        default=["rgb", "obj", "optical_flow", "semantic_segmentation", "instance_segmentation", "depth"],
    )
